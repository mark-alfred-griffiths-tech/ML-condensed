...
def build_decoder_model(hp):
    ...
    nm_neurons_num = hp.Int(name="nm_neurons", min_value=32, max_value=128, step=32)
    ...
    model = decoder_base(ni_neurons_num, nj_neurons_num, nk_neurons_num, nl_neurons_num, nm_neurons_num,
...
def decoder_base(ni_neurons_num, nj_neurons_num, nk_neurons_num, nl_neurons_num, nm_neurons_num,
    ...
    model.add(Dense(nl_neurons_num,
                    ...
                    name="nl_neurons"))
    model.add(Dense(nm_neurons_num, activation=nm_neurons_activation, name="nm_neurons"))
    model.add(Dense(data.dim_x, activation=tf.keras.activations.softmax, name="softmax"))
